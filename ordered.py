...
async def main():
    ...
    parser.add_argument('--m-range', type=int, nargs=3, default=(16, 129, 16), help='range of M')
    parser.add_argument('--n-range', type=int, nargs=3, default=(16, 129, 16), help='range of N')
